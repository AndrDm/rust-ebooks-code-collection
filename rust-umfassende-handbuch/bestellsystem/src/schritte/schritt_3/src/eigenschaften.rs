//! # Eigenschaften
//! In diesem Modul befinden sich Datentypen, die Eigenschaften abbilden.
//! Etwa Hunger oder Durst eines Gasts.

use rand::Rng;
use serde::Deserialize;
use std::ops::{Add, Sub, SubAssign};

/// Repräsentiert einen Durst-Wert.
#[derive(PartialEq, Debug, Copy, Clone, Deserialize, PartialOrd)]
pub struct Durst(pub i32);
/// Repräsentiert einen Hunger-Wert.
#[derive(PartialEq, Debug, Copy, Clone, Deserialize, PartialOrd)]
